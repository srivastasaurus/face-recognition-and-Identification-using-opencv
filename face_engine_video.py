...
video_file = cv2.VideoCapture(os.path.abspath(r"C:\Users\prern\Desktop\facereco\face_recognition_pro\videos\cod_trailer_1.mp4"))

length1 = int(video_file.get(cv2.CAP_PROP_FRAME_COUNT))
print(length1)
# We need to add all the faces that we want our code to recognize
image_alex_1 = face_recognition.load_image_file(os.path.abspath(r"C:\Users\prern\Desktop\facereco\face_recognition_pro\training_images\alex1.png"))
image_badguy_1 = face_recognition.load_image_file(os.path.abspath(r"C:\Users\prern\Desktop\facereco\face_recognition_pro\training_images\badguy1.png"))
image_farah_1 = face_recognition.load_image_file(os.path.abspath(r"C:\Users\prern\Desktop\facereco\face_recognition_pro\training_images\farah1.png"))
image_laswell_1 = face_recognition.load_image_file(os.path.abspath(r"C:\Users\prern\Desktop\facereco\face_recognition_pro\training_images\laswell1.png"))
image_price_1 = face_recognition.load_image_file(os.path.abspath(r"C:\Users\prern\Desktop\facereco\face_recognition_pro\training_images\price1.png"))

#generate the face encoding for teh image that has been passed
...
#make a list of all the known faces that we want to be recognised based on the encoding

known_faces = [alex_face_1 , badguy_face_1 , farah_face_1 , laswell_face_1 , price_face_1]
facial_points = [] 
face_encodings = []
facial_number = 0
